...
var
 ...
 SnakeLen2,SnakeLen, Count : Integer;
  ...
  HeadPic,Head2Pic,ApplePic, TailPic,Tail2Pic,WallPic ,bm: TBitmap;
  dir,dir2 : String;
  flag,flag3,flag2,flag4:boolean;
  timerGame,timerApple,gf:integer;
...
begin
 image2.Picture.LoadFromFile('original2.bmp');
  image1.Picture.LoadFromFile('original2.bmp');
...
begin
  ...
  if RadioButton2.Checked then
     ...
     timerGame:=timerGame+1;
        ...
        if (gf<20) and (timerApple=0) then
   begin
     ApplePic.LoadFromFile('Black.bmp');
     timerApple:=10;
       gf:=100;
     end;
  if (timerApple=0) then
  begin
    ApplePic.LoadFromFile('red.bmp');
    Label10.Caption:='Ешь';
  end
  ELSE
  begin
  timerApple:=timerApple-1;
   Label10.Caption:='Не созрело,осталось:'+inttostr(timerApple);
  end;
end;
